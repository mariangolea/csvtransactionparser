...
public class CompanyNamesPeristenceHandler extends UserPreferencesHandlerBase {
    ...
    public CompanyNamesPeristenceHandler(final UserPreferencesInterface userPreferences) {
        super(userPreferences);
    }

    public CompanyNamesPeristenceHandler(final UserPreferencesInterface userPreferences, final String preferencesFolder) {

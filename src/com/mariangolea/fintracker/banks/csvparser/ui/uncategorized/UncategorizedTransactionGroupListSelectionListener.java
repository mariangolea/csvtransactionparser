...
public class UncategorizedTransactionGroupListSelectionListener implements ListChangeListener {
    ...
    private final ListView<BankTransactionGroupInterface> list;
    private final Label amountArea;

    public UncategorizedTransactionGroupListSelectionListener(ListView<BankTransactionGroupInterface> list, Label amountArea) {
        this.list = list;

...
import com.mariangolea.fintracker.banks.pdfparser.api.transaction.BankTransaction.Type;
...
public class INGParser extends AbstractBankParser {
	...
	public BankTransaction parseTransaction(List<String> toConsume) {
		...
		if (operation != null) {
			...
			transaction = new BankTransaction(Bank.ING.swiftCode, operation.desc, startDate, completedDate, amount,
					desc, operationType, toConsume.subList(0, linesConsumed));
		}
